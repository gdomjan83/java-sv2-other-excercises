...
class JurassicParkTest {
    ...
    void init() throws SQLException {
        ...
        dataSource.setUrl("jdbc:mariadb://localhost:3306/jurassic_db?useUnicode=true");
        dataSource.setUser("root");
        dataSource.setPassword("root456");

        Flyway flyway = Flyway.configure().locations("db/migration/jurassic").dataSource(dataSource).load();

...
//        dataSource.setUrl("jdbc:mariadb://localhost:3306/webshop_db?useUnicode=true");
//        dataSource.setUser("root");
//        dataSource.setPassword("root456");
//
//        Flyway flyway = Flyway.configure().locations("/db/migration/webshop").dataSource(dataSource).load();
//
//        flyway.clean();
//        flyway.migrate();
//

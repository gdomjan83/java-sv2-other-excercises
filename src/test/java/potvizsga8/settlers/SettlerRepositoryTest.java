...
class SettlerRepositoryTest {
    ...
    void init() {
        try {
            ...
            dataSource.setUrl("jdbc:mariadb://localhost:3306/settlers_db?useUnicode=true");
        ...
        Flyway fw = Flyway.configure().locations("db/migration/settlers").dataSource(dataSource).load();
        fw.clean();
        fw.migrate();
